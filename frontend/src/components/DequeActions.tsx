	...
	return (
		<div class='mt-2 bg-base-300  rounded-lg p-8 cursor-default'>
			<div class='bg-white rounded-md p-4'>
				<p class='font-bold uppercase font-2xl text-center cursor-help font-prata text-black'>
					2 of 7 Cards Answered
				</p>
			</div>

			<div class='mt-16'>
				<div class='mb-16 bg-accent rounded-xl cursor-progress p-4 text-black font-bold text-2xl text-center font-prata'>
					<p>
